...
// we call constructor and show the object related to joe in console (undefiend)
//
// 2. What is "this" when joe.scopeArrow() is invoked?
//this is arrow function when we call it , it will use the value of this in which it was defiend  (undefined)
// 3. Explain why "this" is different when an arrow function is used.
//(this) is required to help pass the this context into the function.  Otherwise, by default this would be undefined.
